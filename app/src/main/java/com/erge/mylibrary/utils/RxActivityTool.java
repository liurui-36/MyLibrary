...
public class RxActivityTool {
    ...
    private static final String TAG = "RxActivityTool";
    ...
    public static void addActivity(Activity activity) {
        ...
        Log.i(TAG, "addActivity : " + activity.getComponentName().getShortClassName());
        activityStack.add(activity);
    }

    public static void removeActivity(Activity activity) {
        Log.i(TAG, "removeActivity : " + activity.getComponentName().getShortClassName());
