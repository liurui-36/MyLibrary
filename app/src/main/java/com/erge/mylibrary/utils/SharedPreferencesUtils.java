...
public class SharedPreferencesUtils {
    ...
    public static void saveString(String key, String value) {
        PreferenceManager.getDefaultSharedPreferences(MyLibrary.getInstance().getApp())
    ...
    public static String getString(String key, String defaultValue) {
        return PreferenceManager.getDefaultSharedPreferences(MyLibrary.getInstance().getApp())
